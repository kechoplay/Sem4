    ...
    <form class="form-horizontal qtyFrm" method="POST" action="addcart.php?proid=<?php echo $listid[0] ?>">
      <div class="control-group">
        <label class="control-label">
          <span><?php echo number_format($listid[3]-$listid[4]); ?> VNĐ</span>
        ...
        <div class="thumbnail">
          ...
          <div class="caption">
            ...
            <h4 style="text-align:center">
              ...
              <a class="btn btn-primary" href="#"><?php echo number_format($value['pro_price']-$value['pro_discount']); ?></a>
              <a class="btn btn-primary" style="text-decoration:line-through;" href="#"><?php echo number_format($value['pro_price']); ?></a>
            </h4>
          </div>
        </div>
      </li>
